...
module.exports = options => ({
  ...
  code(input, filepath) {
    ...
    const { extractedCSS, sourceMap } = parse(input, absolutePath, Object.assign({}, DEFAULT_OPTIONS, options));
  ...
  result(stylelintResult, filepath) {
    ...
    const warnings = stylelintResult.warnings.map(warning => Object.assign({}, warning, {
